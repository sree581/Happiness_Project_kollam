...
export default function CommonQuestions() {
  ...
  return (
    <section id="common-questions" className="px-6 py-20">
      <div className="max-w-4xl mx-auto">
        <p className="text-sm tracking-widest uppercase mb-6" style={{ color: '#6F6F6F' }}>Before you write to us</p>
        <h2 className="text-4xl sm:text-5xl mb-10" style={{ fontFamily: 'var(--font-display)', color: 'var(--title-brown)' }}>
        ...
        <div className="space-y-3">
          {faqs.map((f, i) => (
            <div key={f.q} className="liquid-card rounded-[1.25rem] px-5 py-4">
              ...
              >
                <span className="text-lg" style={{ fontFamily: 'var(--font-display)', color: 'var(--title-brown)' }}>{f.q}</span>
